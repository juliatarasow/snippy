...
import { Flex, Box, Button, Heading, HStack, Separator, VStack } from '@chakra-ui/react'
...
import CreateButtons from '../../components/buttons/CreateButtons'
import CreateOneButton from '../../components/buttons/CreateOneButton'
    ...
    return (
        <Flex width="100%" alignItems="center" direction="column">
            ...
            >
                ...
                <Separator borderWidth="3px" color="secondary" w="99%" />
